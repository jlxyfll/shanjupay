...
public class WxPayController {
     ...
     */
    String wxOAuth2CodeReturnUrl = "http://zr8596.natappfree.cc/transaction/wx-oauth-code-return-test";
    String state = "";
    ...
    public String getWXOAuth2Code(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    /**
     * 授权回调，传入授权码和state ，/ wx‐oauth‐code‐return‐test?code=CODE&state=STATE
     *
     * @param code  授权码
    ...
    public String wxOAuth2CodeReturn(@RequestParam String code, @RequestParam String state) {
        ...
        //重定向到统一下单接口
        return "redirect:http://zr8596.natappfree.cc/transaction/wxjspay?openid=" + openid;
    }
    //统一下单，接收openid
    @GetMapping("/wxjspay")
